...
export const Route = createFileRoute('/plan-de-site')({
  ...
  head: () => ({ meta: [{ title: "Plan du site â€” FIH Â· RVA" }] }),
});
...
const SECTIONS = [
  {
    ...
    base: '/vols',
    links: [
      { label: 'DÃ©parts en temps rÃ©el', href: '/vols/departs' },
      { label: 'ArrivÃ©es en temps rÃ©el', href: '/vols/arrivees' },
      { label: 'Compagnies aÃ©riennes', href: '/vols/compagnies-aeriennes' },
      { label: 'Alertes WhatsApp', href: '/vols/alertes-whatsapp' },
      { label: 'Temps d\'attente', href: '/vols/temps-attente' },
      { label: 'Plans des aÃ©rogares', href: '/vols/plans-aerogares' },
    ],
  },
  {
    ...
    links: [
      { label: 'Stationnement FIH', href: '/stationnement-transport/formulaire' },
      { label: 'Offres & Tarifs', href: '/stationnement-transport/offres' },
      { label: 'MobilitÃ© rÃ©duite', href: '/stationnement-transport/mobilite-reduite' },
      { label: 'DÃ©pose & RÃ©cupÃ©ration', href: '/stationnement-transport/depose-recuperation' },
      { label: 'Avis Travaux', href: '/stationnement-transport/travaux' },
      { label: 'Taxis agrÃ©Ã©s', href: '/stationnement-transport/taxis' },
  ...
  },
  {
    ...
    links: [
      { label: 'RÃ©pertoire', href: '/boutiques-restaurants/repertoire' },
      { label: 'Restaurants', href: '/boutiques-restaurants/restaurants' },
      { label: 'Boutiques', href: '/boutiques-restaurants/boutiques' },
      { label: 'Bars & CafÃ©s', href: '/boutiques-restaurants/bars-cafes' },
  ...
  {
    title: 'Guide de l\'aÃ©roport',
    base: '/guide',
    links: [
      { label: 'Quitter Kinshasa', href: '/guide/quitter-kinshasa' },
      { label: 'SÃ©curitÃ© & Bagages', href: '/guide/securite-bagages' },
      { label: 'Atterrir Ã  Kinshasa', href: '/guide/atterrir-kinshasa' },
      { label: 'Douanes & Immigration', href: '/guide/douanes-immigration' },
      { label: 'Correspondances', href: '/guide/correspondances' },
      { label: 'SantÃ© & Vaccinations', href: '/guide/sante' },
      { label: 'Wi-Fi & ConnectivitÃ©', href: '/guide/wifi-connectivite' },
      { label: 'Services bancaires', href: '/guide/services-bancaires' },
      { label: 'Objets trouvÃ©s', href: '/guide/objets-trouves' },
      { label: 'Passagers handicapÃ©s', href: '/guide/passagers-handicap' },
  ...
  },
  {
    ...
    base: '/corporate',
    links: [
      { label: 'Ã€ propos de la RVA', href: '/corporate/a-propos' },
      ...
      { label: 'CarriÃ¨res', href: '/corporate/carriere' },
      { label: 'Partenariats commerciaux', href: '/corporate/partenariats-commerciaux' },
      { label: 'Services aÃ©riens', href: '/corporate/services-aeriens' },
      { label: 'SÃ»retÃ© & SÃ©curitÃ©', href: '/corporate/surete-securite' },
    ],
  },
  {
    title: 'CommunautÃ©',
    base: '/communaute',
    links: [
      { label: 'Environnement & DurabilitÃ©', href: '/communaute/environnement-durabilite' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'CrÃ©er un compte', href: '/inscription' },
      { label: 'Mon compte', href: '/compte' },
      { label: 'Mon profil', href: '/compte/profil' },
      { label: 'Mes rÃ©servations', href: '/compte/reservations' },
      { label: 'Vols suivis', href: '/compte/vols-suivis' },
      { label: 'PrÃ©fÃ©rences', href: '/compte/preferences' },
    ],
  },
  {
    title: 'LÃ©gal & Contact',
    base: '/',
    links: [
      { label: 'Contact', href: '/contact' },
      { label: 'FAQ', href: '/faq' },
      { label: 'Conditions d\'utilisation', href: '/conditions-utilisation' },
      { label: 'Politique de confidentialitÃ©', href: '/politique-confidentialite' },

...
function ArriveesPage() {
  ...
  return (
    <main id="main-content">
      ...
      {/* ─── Hero ADMTL-style — image très visible ─────────────────── */}
      <div ref={heroRef} className="relative overflow-hidden bg-[#0F2A1E]">
        <img
          src="/images/fih-checkin-ethiopian.jpg"
          className="absolute inset-0 h-full w-full select-none object-cover object-center opacity-65 pointer-events-none"
          alt=""
          aria-hidden="true"
        />
        {/* Gradient couvre seulement le tiers gauche — image respire à droite */}
        <div
          className="absolute inset-0"
          style={{
            background:
              'linear-gradient(to right, #0F2A1E 0%, #0F2A1E 20%, rgba(15,42,30,0.80) 42%, rgba(15,42,30,0.25) 62%, transparent 80%)',
          }}
        />
      ...
      {/* ─── Barre sticky collapsée — apparaît quand le hero est scrollé ─ */}
      <div
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <span
                ...
                aria-label="Actualiser"
                className="text-white/40 hover:text-white/70 disabled:opacity-30 cursor-pointer"
              >
